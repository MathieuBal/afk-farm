...
(function () {
  ...
  const TYPES = {
    ...
    storage:     { label: "Soute",         icon: "📦", apply: (s) => (s.storage += 60) },
    // notables
    ...
    warehouse:   { label: "Entrepôt",      icon: "🏭", notable: true, apply: (s) => (s.storage += 200) },
  ...
  const DESC = {
    ...
    density: "Repousse des grains plus rapide (+débit de récolte)",
